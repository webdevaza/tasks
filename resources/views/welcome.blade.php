...
<html lang="en">
  <head>
    ...
    <style>
      .gradient {
        background: linear-gradient(90deg, #068b23 0%, #60a557 100%);
      }
    </style>
  </head>
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
        ...
        @if (Route::has('login'))
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    ...
                    @else
                    <li class="mr-3">
                        <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="{{route('login')}}">Log in</a>
                    </li>
                    @if (Route::has('register'))
                        <a
                            id="navAction"
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        <!--Left Col-->
        <div class="flex flex-col w-full justify-center items-start text-center md:text-center">
          <p class="uppercase tracking-loose w-full">Wanna manage your time?</p>
          <h1 class="my-4 text-5xl font-bold leading-tight mx-auto">
            Plan your day, plan your life!
          </h1>
          <p class="leading-normal text-2xl mb-8 mx-auto">
            All the successful people around the world live planning!
          </p>
          <button class="mx-auto lg:mx-auto hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
            Start
          </button>
        </div>
